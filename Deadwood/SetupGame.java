...
public class SetupGame {
    ...
    public SetupGame(int numPlayers) {
        // Exception catch
        try{
            GameData.initializeGameData(getClass().getClassLoader().getResourceAsStream("CSCI_345_cox_hafner/xml/board.xml"),
                                        getClass().getClassLoader().getResourceAsStream("CSCI_345_cox_hafner/xml/cards.xml"));
